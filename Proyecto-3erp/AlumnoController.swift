...
class AlumnoController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        Horario.append(horario(materia: "Programacion", maestro: "Armando Zamora", hora: "9:00 - 11:00 am", fotop: "programacion", asistencia: false,califMaestro: "", comentMaestro: "",evaluacion: false, faltitas: "1"))
        ...
        Horario.append(horario(materia: "Mexico global", maestro: "Marisela Delgadillo", hora: "1:00 - 2:00 pm", fotop: "mexico",asistencia: false,califMaestro: "",comentMaestro: "",evaluacion: false, faltitas: "0"))
